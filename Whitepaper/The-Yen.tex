\def \projectname{The Yen\xspace}

\def \company{Mesonox Softworks}
\def \companyref{N/A}
\def \companytype{Sole Proprietorship}
\def \team{N/A}
\def \restrictions{Proprietary Information}
\def \title{\projectname}
\def \biline{An invite-only social network}
\def \author{Adrian Smith}
\def \email{adrianrsmith@gmail.com}
\def \phone{530-739-5401}
\def \address{1701 E Cotati #755, Rohnert Park, CA 96093}
